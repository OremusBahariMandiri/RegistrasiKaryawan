...
@section('title', 'Tambah Keluarga Inti')
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-user-friends me-2"></i>Tambah Data Keluarga Inti</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('keluarga-inti.store') }}" method="POST">
                            @csrf
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('sts_ki') is-invalid @enderror"
                                                        ...
                                                        <option value="SUAMI"
                                                            {{ old('sts_ki') == 'SUAMI' ? 'selected' : '' }}>SUAMI</option>
                                                        <option value="ISTRI"
                                                            {{ old('sts_ki') == 'ISTRI' ? 'selected' : '' }}>ISTRI</option>
                                                        <option value="ANAK KE 1"
                                                            {{ old('sts_ki') == 'ANAK KE 1' ? 'selected' : '' }}>
                                                            ANAK KE 1</option>
                                                        <option value="ANAK KE 2"
                                                            {{ old('sts_ki') == 'ANAK KE 2' ? 'selected' : '' }}>
                                                            ANAK KE 2</option>
                                                        <option value="ANAK KE 3"
                                                            {{ old('sts_ki') == 'ANAK KE 3' ? 'selected' : '' }}>
                                                            ANAK KE 3</option>
                                                        <option value="ANAK KE 4"
                                                            {{ old('sts_ki') == 'ANAK KE 4' ? 'selected' : '' }}>
                                                            ANAK KE 4</option>
                                                        <option value="ANAK KE 5"
                                                            {{ old('sts_ki') == 'ANAK KE 5' ? 'selected' : '' }}>
                                                            ANAK KE 5</option>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('sex_ki') is-invalid @enderror"
                                                        ...
                                                        <option value="LAKI-LAKI"
                                                            {{ old('sex_ki') == 'LAKI-LAKI' ? 'selected' : '' }}>LAKI-LAKI
                                                        </option>
                                                        <option value="PEREMPUAN"
                                                            {{ old('sex_ki') == 'PEREMPUAN' ? 'selected' : '' }}>PEREMPUAN
                                                        </option>
                                                    </select>
                                                </div>
                                                @error('sex_ki')
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="nama_ki" name="nama_ki" value="{{ old('nama_ki') }}"
                                                        required>
                                                </div>
                                                @error('nama_ki')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('tgl_lahir_ki') }}" required>
                                                </div>
                                                @error('tgl_lahir_ki')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select
                                                        class="form-select @error('keberadaan_ki') is-invalid @enderror"
                                                        id="keberadaan_ki" name="keberadaan_ki" required>
                                                        <option value="">Pilih Keberadaan</option>
                                                        <option value="HIDUP"
                                                            {{ old('keberadaan_ki') == 'HIDUP' ? 'selected' : '' }}>HIDUP
                                                        </option>
                                                        <option value="MENINGGAL"
                                                            {{ old('keberadaan_ki') == 'MENINGGAL' ? 'selected' : '' }}>
                                                            MENINGGAL</option>
                                                    </select>
                                                </div>
                                                @error('keberadaan_ki')
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="ijazah_ki" name="ijazah_ki" value="{{ old('ijazah_ki') }}">
                                                </div>
                                                @error('ijazah_ki')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('domisili_ki') is-invalid @enderror" id="domisili_ki" name="domisili_ki"
                                                        rows="2">{{ old('domisili_ki') }}</textarea>
                                                </div>
                                                @error('domisili_ki')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
