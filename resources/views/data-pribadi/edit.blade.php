...
@section('title', 'Edit Calon Karyawan')
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-user-edit me-2"></i>Edit Calon Karyawan</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('data-pribadi.update', $calonKaryawan->id) }}" method="POST"
                            id="calonKaryawanForm">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="id_kode" value="{{ $calonKaryawan->id_kode }}">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="nik_ktp_c_kry"
                                                                name="nik_ktp_c_kry"
                                                                value="{{ old('nik_ktp_c_kry', $calonKaryawan->nik_ktp_c_kry) }}"
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="no_calon_kry"
                                                                        name="no_calon_kry"
                                                                        value="{{ old('no_calon_kry', $calonKaryawan->no_calon_kry) }}"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="date" class="form-control"
                                                                        ...
                                                                        value="{{ old('tgl_daftar', $calonKaryawan->tgl_daftar ? $calonKaryawan->tgl_daftar->format('Y-m-d') : '') }}"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="nama_c_kry"
                                                                name="nama_c_kry"
                                                                value="{{ old('nama_c_kry', $calonKaryawan->nama_c_kry) }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('tempat_lhr_c_kry', $calonKaryawan->tempat_lhr_c_kry) }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="{{ old('tanggal_lhr_c_kry', $calonKaryawan->tanggal_lhr_c_kry ? $calonKaryawan->tanggal_lhr_c_kry->format('Y-m-d') : '') }}"
                                                                required>
                                                        </div>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-select" id="sex_c_kry" name="sex_c_kry"
                                                                ...
                                                                <option value="LAKI-LAKI"
                                                                    {{ old('sex_c_kry', $calonKaryawan->sex_c_kry) == 'LAKI-LAKI' ? 'selected' : '' }}>
                                                                    LAKI-LAKI</option>
                                                                <option value="PEREMPUAN"
                                                                    {{ old('sex_c_kry', $calonKaryawan->sex_c_kry) == 'PEREMPUAN' ? 'selected' : '' }}>
                                                                    PEREMPUAN</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-select" id="agama_c_kry"
                                                                ...
                                                                <option value="" disabled>Pilih Agama
                                                                </option>
                                                                <option value="ISLAM"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'ISLAM' ? 'selected' : '' }}>
                                                                    ISLAM</option>
                                                                <option value="KRISTEN"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'KRISTEN' ? 'selected' : '' }}>
                                                                    KRISTEN</option>
                                                                <option value="KATOLIK"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'KATOLIK' ? 'selected' : '' }}>
                                                                    KATOLIK</option>
                                                                <option value="HINDU"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'HINDU' ? 'selected' : '' }}>
                                                                    HINDU</option>
                                                                <option value="BUDDHA"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'BUDDHA' ? 'selected' : '' }}>
                                                                    BUDDHA</option>
                                                                <option value="KONGHUCU"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'KONGHUCU' ? 'selected' : '' }}>
                                                                    KONGHUCU</option>
                                                                <option value="LAINYA"
                                                                    {{ old('agama_c_kry', $calonKaryawan->agama_c_kry) == 'LAINYA' ? 'selected' : '' }}>
                                                                    LAINYA</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-select" id="sts_kawin_c_kry"
                                                                ...
                                                                <option value="BELUM KAWIN"
                                                                    {{ old('sts_kawin_c_kry', $calonKaryawan->sts_kawin_c_kry) == 'BELUM KAWIN' ? 'selected' : '' }}>
                                                                    BELUM KAWIN</option>
                                                                <option value="KAWIN"
                                                                    {{ old('sts_kawin_c_kry', $calonKaryawan->sts_kawin_c_kry) == 'KAWIN' ? 'selected' : '' }}>
                                                                    KAWIN</option>
                                                                <option value="CERAI HIDUP"
                                                                    {{ old('sts_kawin_c_kry', $calonKaryawan->sts_kawin_c_kry) == 'CERAI HIDUP' ? 'selected' : '' }}>
                                                                    CERAI HIDUP</option>
                                                                <option value="CERAI MATI"
                                                                    {{ old('sts_kawin_c_kry', $calonKaryawan->sts_kawin_c_kry) == 'CERAI MATI' ? 'selected' : '' }}>
                                                                    CERAI MATI</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('pekerjaan_c_kry', $calonKaryawan->pekerjaan_c_kry) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('warganegara_c_kry', $calonKaryawan->warganegara_c_kry ?: 'INDONESIA') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="telpon1_c_kry"
                                                                name="telpon1_c_kry"
                                                                value="{{ old('telpon1_c_kry', $calonKaryawan->telpon1_c_kry) }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="telpon2_c_kry"
                                                                name="telpon2_c_kry"
                                                                value="{{ old('telpon2_c_kry', $calonKaryawan->telpon2_c_kry) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="email" class="form-control" id="email_c_kry"
                                                                name="email_c_kry"
                                                                value="{{ old('email_c_kry', $calonKaryawan->email_c_kry) }}">
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('instagram_c_kry', $calonKaryawan->instagram_c_kry) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" id="alamat_ktp_c_kry"
                                                        ...
                                                        value="{{ old('alamat_ktp_c_kry', $calonKaryawan->alamat_ktp_c_kry) }}" />
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('rt_rw_ktp_c_kry', $calonKaryawan->rt_rw_ktp_c_kry) }}"
                                                                placeholder="000/000">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('kelurahan_ktp_c_kry', $calonKaryawan->kelurahan_ktp_c_kry) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('kecamatan_ktp_c_kry', $calonKaryawan->kecamatan_ktp_c_kry) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                value="{{ old('kode_pos_ktp_c_kry', $calonKaryawan->kode_pos_ktp_c_kry) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('kota_ktp_c_kry', $calonKaryawan->kota_ktp_c_kry) }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('provinsi_ktp_c_kry', $calonKaryawan->provinsi_ktp_c_kry) }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="domisili_sama"
                                                        name="domisili_sama"
                                                        {{ $calonKaryawan->domisili_c_kry == '1' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" id="alamat_dom_c_kry"
                                                            ...
                                                            value="{{ old('alamat_dom_c_kry', $calonKaryawan->alamat_dom_c_kry) }}" />
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('rt_rw_dom_c_kry', $calonKaryawan->rt_rw_dom_c_kry) }}"
                                                                    placeholder="000/000">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('kelurahan_dom_c_kry', $calonKaryawan->kelurahan_dom_c_kry) }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('kecamatan_dom_c_kry', $calonKaryawan->kecamatan_dom_c_kry) }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="{{ old('kode_pos_dom_c_kry', $calonKaryawan->kode_pos_dom_c_kry) }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('kota_dom_c_kry', $calonKaryawan->kota_dom_c_kry) }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('provinsi_dom_c_kry', $calonKaryawan->provinsi_dom_c_kry) }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" id="hobi_c_kry" name="hobi_c_kry" rows="3">{{ old('hobi_c_kry', $calonKaryawan->hobi_c_kry) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" id="kelebihan_c_kry" name="kelebihan_c_kry" rows="3">{{ old('kelebihan_c_kry', $calonKaryawan->kelebihan_c_kry) }}</textarea>
                                                        </div>
                                                        <div class="form-text text-muted">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" id="kekurangan_c_kry" name="kekurangan_c_kry" rows="3">{{ old('kekurangan_c_kry', $calonKaryawan->kekurangan_c_kry) }}</textarea>
                                                        </div>
                                                        <div class="form-text text-muted">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-white" style="background-color:#02786e">
                    <h5 class="modal-title" id="confirmationModalLabel">Konfirmasi Perbarui Data</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin memperbarui data calon karyawan ini?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="confirmSubmit">Ya, Perbarui</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize domisili fields state based on checkbox
            if (domisiliSamaCheckbox.checked) {
            ...
            // Add event listeners for KTP fields to update Domisili fields when checkbox is checked
            document.querySelectorAll(
                    '#alamat_ktp_c_kry, #rt_rw_ktp_c_kry, #kelurahan_ktp_c_kry, #kecamatan_ktp_c_kry, #kota_ktp_c_kry, #provinsi_ktp_c_kry, #kode_pos_ktp_c_kry'
                )
                .forEach(function(input) {
                    input.addEventListener('change', function() {
                        if (domisiliSamaCheckbox.checked) {
                            const domField = this.id.replace('ktp', 'dom');
                            document.getElementById(domField).value = this.value;
                        }
                    });
                });

            // ==========================================
            // BAGIAN SCRIPT UNTUK AUTO UPPERCASE
            // ==========================================

            // Pengaturan: Daftar id field yang dikecualikan dari uppercase
            const excludedFields = ['email_c_kry'];

            // Fungsi untuk mengecek apakah elemen harus dikecualikan
            function shouldExclude(element) {
                return excludedFields.includes(element.id);
            }

            // Fungsi untuk menerapkan uppercase pada elemen input
            function applyUppercase(element) {
                // Skip jika elemen dalam daftar pengecualian
                ...
                if (element.nodeName === 'INPUT' &&
                    (element.type === 'text' || element.type === 'hidden' ||
                        element.type === 'search' || element.type === 'tel') ||
                    element.nodeName === 'TEXTAREA') {

                    // Event untuk mengubah teks menjadi uppercase saat input
                    element.addEventListener('input', function() {
                        // Simpan posisi kursor
                        const start = this.selectionStart;
                        const end = this.selectionEnd;

                        // Ubah teks menjadi uppercase
                    ...
                    // Event untuk mengubah teks menjadi uppercase saat blur
                    element.addEventListener('blur', function() {
                        this.value = this.value.toUpperCase();
                    });

                    // Ubah nilai yang sudah ada menjadi uppercase
                    if (element.value) {
                        const originalValue = element.value;
                        element.value = originalValue.toUpperCase();
                    }
                } else if (element.nodeName === 'SELECT') {
                    // Untuk select elements dengan opsi custom (jika ada)
                    element.querySelectorAll('option').forEach(function(option) {
                        if (option.value && option.innerHTML && !shouldExclude(element)) {
                            option.innerHTML = option.innerHTML.toUpperCase();
                        }
                    });
                }
            }

            // Fungsi untuk menerapkan uppercase pada semua elemen yang sesuai
            function applyUppercaseToAll() {
                // Seleksi semua input text, hidden, search, tel dan textarea
                const textInputs = document.querySelectorAll(
                    'input[type="text"], input[type="hidden"], input[type="search"], input[type="tel"], textarea'
                );
                textInputs.forEach(applyUppercase);

                // Seleksi semua select elements
                const selectInputs = document.querySelectorAll('select');
                selectInputs.forEach(applyUppercase);
            }

            // Panggil fungsi saat halaman dimuat
            applyUppercaseToAll();

            // Gunakan MutationObserver untuk menangani elemen yang ditambahkan secara dinamis
                ...
                mutations.forEach(function(mutation) {
                    if (mutation.type === 'childList' && mutation.addedNodes.length > 0) {
                        mutation.addedNodes.forEach(function(node) {
                            ...
                            if (node.nodeType === 1) {
                                // Periksa apakah node adalah input, textarea, atau select
                                if ((node.nodeName === 'INPUT' &&
                                        (node.type === 'text' || node.type === 'hidden' ||
                                            node.type === 'search' || node.type === 'tel')
                                    ) ||
                                ...
                                // Periksa child elements dari node yang baru ditambahkan
                                const childElements = node.querySelectorAll(
                                    'input[type="text"], input[type="hidden"], input[type="search"], input[type="tel"], textarea, select'
                                );
                                childElements.forEach(applyUppercase);
                            }
                        });
                    }
                });
            ...
            // Konfigurasi observer untuk memantau seluruh dokumen
            observer.observe(document.body, {
                childList: true,
                subtree: true
            });

            // Event handler untuk perubahan elemen DOM yang dibuat oleh JavaScript frameworks
            // (seperti Vue, React, Angular, dll)
            setInterval(function() {
                const newInputs = document.querySelectorAll(
                    'input[type="text"]:not([data-uppercase-applied]), ' +
                    'input[type="hidden"]:not([data-uppercase-applied]), ' +
                    'input[type="search"]:not([data-uppercase-applied]), ' +
                    'input[type="tel"]:not([data-uppercase-applied]), ' +
                    'textarea:not([data-uppercase-applied]), ' +
                    'select:not([data-uppercase-applied])'
                );

                newInputs.forEach(function(element) {
                    element.setAttribute('data-uppercase-applied', 'true');
                    applyUppercase(element);
                });
            }, 1000);

            // Untuk domisili checkbox - Tambahkan event untuk uppercase setelah copy
            domisiliSamaCheckbox.addEventListener('change', function() {
                if (this.checked) {
                    // Setelah nilai disalin, pastikan juga di-uppercase
                    setTimeout(function() {
                        document.querySelectorAll('#domisili_fields input').forEach(input => {
                            if (input.value && !shouldExclude(input)) {
