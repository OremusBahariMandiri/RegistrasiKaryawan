...
@section('title', 'Edit Data Riwayat Kerja')
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Data Riwayat Kerja</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>Edit data riwayat kerja untuk:
                            <strong>{{ $riwayatKerja->pribadiCalonKaryawan->nama_c_kry }}</strong>
                            (NIK: {{ $riwayatKerja->pribadiCalonKaryawan->nik_ktp_c_kry }})
                        </div>

                        <form action="{{ route('riwayat-kerja.update', $riwayatKerja->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="perusahaan_rkj"
                                                           name="perusahaan_rkj"
                                                           value="{{ old('perusahaan_rkj', $riwayatKerja->perusahaan_rkj) }}"
                                                           required>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="departemen_rkj"
                                                           name="departemen_rkj"
                                                           value="{{ old('departemen_rkj', $riwayatKerja->departemen_rkj) }}"
                                                           required>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="jabatan_rkj"
                                                           name="jabatan_rkj"
                                                           value="{{ old('jabatan_rkj', $riwayatKerja->jabatan_rkj) }}"
                                                           required>
                                                </div>
                                                @error('jabatan_rkj')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="wilker_rkj"
                                                           name="wilker_rkj"
                                                           value="{{ old('wilker_rkj', $riwayatKerja->wilker_rkj) }}">
                                                </div>
                                                @error('wilker_rkj')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"
                                                           ...
                                                           id="tgl_mulai_rkj"
                                                           name="tgl_mulai_rkj"
                                                           value="{{ old('tgl_mulai_rkj', $riwayatKerja->tgl_mulai_rkj ? $riwayatKerja->tgl_mulai_rkj->format('Y-m-d') : '') }}"
                                                           required>
                                                </div>
                                                @error('tgl_mulai_rkj')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"
                                                           ...
                                                           value="{{ old('tgl_berakhir_rkj', $riwayatKerja->tgl_berakhir_rkj ? $riwayatKerja->tgl_berakhir_rkj->format('Y-m-d') : '') }}">
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           value="{{ old('masa_kerja_rkj', $riwayatKerja->masa_kerja_rkj) }}">
                                                </div>
                                                <div class="form-text text-muted">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number"
                                                           ...
                                                           value="{{ old('penghasilan_rkj', $riwayatKerja->penghasilan_rkj) }}">
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea
                                                        ...
                                                        rows="3">{{ old('ket_berhenti_rkj', $riwayatKerja->ket_berhenti_rkj) }}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="nama_ref"
                                                           name="nama_ref"
                                                           value="{{ old('nama_ref', $riwayatKerja->nama_ref) }}">
                                                </div>
                                                @error('nama_ref')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('sex_ref') is-invalid @enderror"
                                                        ...
                                                        @foreach($sexReferensi as $kode => $jenis)
                                                            <option value="{{ $kode }}" {{ old('sex_ref', $riwayatKerja->sex_ref) == $kode ? 'selected' : '' }}>
                                                                {{ $jenis }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="departemen_ref"
                                                           name="departemen_ref"
                                                           value="{{ old('departemen_ref', $riwayatKerja->departemen_ref) }}">
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="jabatan_ref"
                                                           name="jabatan_ref"
                                                           value="{{ old('jabatan_ref', $riwayatKerja->jabatan_ref) }}">
                                                </div>
                                                @error('jabatan_ref')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="telpon_ref"
                                                           name="telpon_ref"
                                                           value="{{ old('telpon_ref', $riwayatKerja->telpon_ref) }}">
                                                </div>
                                                @error('telpon_ref')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           value="{{ old('hubungan_ref', $riwayatKerja->hubungan_ref) }}">
                                                </div>
                                                @error('hubungan_ref')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
