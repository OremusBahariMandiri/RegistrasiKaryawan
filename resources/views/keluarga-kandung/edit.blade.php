...
@section('title', 'Edit Keluarga Kandung')
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-user-friends me-2"></i>Edit Data Keluarga Kandung</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('keluarga-kandung.update', $keluargaKandung->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('sts_kkd') is-invalid @enderror"
                                                        ...
                                                        <option value="AYAH"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'AYAH' ? 'selected' : '' }}>
                                                            AYAH</option>
                                                        <option value="IBU"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'IBU' ? 'selected' : '' }}>
                                                            IBU</option>
                                                        <option value="ANAK KE 1"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'ANAK KE 1' ? 'selected' : '' }}>
                                                            ANAK KE 1</option>
                                                        <option value="ANAK KE 2"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'ANAK KE 2' ? 'selected' : '' }}>
                                                            ANAK KE 2</option>
                                                        <option value="ANAK KE 3"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'ANAK KE 3' ? 'selected' : '' }}>
                                                            ANAK KE 3</option>
                                                        <option value="ANAK KE 4"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'ANAK KE 4' ? 'selected' : '' }}>
                                                            ANAK KE 4</option>
                                                        <option value="ANAK KE 5"
                                                            {{ old('sts_kkd', $keluargaKandung->sts_kkd) == 'ANAK KE 5' ? 'selected' : '' }}>
                                                            ANAK KE 5</option>
                                                    </select>
                                                </div>
                                                @error('sts_kkd')
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('sex_kkd') is-invalid @enderror"
                                                        ...
                                                        <option value="LAKI-LAKI"
                                                            {{ old('sex_kkd', $keluargaKandung->sex_kkd) == 'LAKI-LAKI' ? 'selected' : '' }}>
                                                            LAKI-LAKI
                                                        </option>
                                                        <option value="PEREMPUAN"
                                                            {{ old('sex_kkd', $keluargaKandung->sex_kkd) == 'PEREMPUAN' ? 'selected' : '' }}>
                                                            PEREMPUAN
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="nama_kkd" name="nama_kkd"
                                                        value="{{ old('nama_kkd', $keluargaKandung->nama_kkd) }}" required>
                                                </div>
                                                @error('nama_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('tgl_lahir_kkd', $keluargaKandung->tgl_lahir_kkd ? $keluargaKandung->tgl_lahir_kkd->format('Y-m-d') : '') }}"
                                                        required>
                                                </div>
                                                @error('tgl_lahir_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="HIDUP"
                                                            {{ old('keberadaan_kkd', $keluargaKandung->keberadaan_kkd) == 'HIDUP' ? 'selected' : '' }}>
                                                            HIDUP
                                                        </option>
                                                        <option value="MENINGGAL"
                                                            {{ old('keberadaan_kkd', $keluargaKandung->keberadaan_kkd) == 'MENINGGAL' ? 'selected' : '' }}>
                                                            MENINGGAL</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('ijazah_kkd', $keluargaKandung->ijazah_kkd) }}">
                                                </div>
                                                @error('ijazah_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('institusi_kkd', $keluargaKandung->institusi_kkd) }}">
                                                </div>
                                                @error('institusi_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('jurusan_kkd', $keluargaKandung->jurusan_kkd) }}">
                                                </div>
                                                @error('jurusan_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('pekerjaan_kkd', $keluargaKandung->pekerjaan_kkd) }}">
                                                </div>
                                                @error('pekerjaan_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('domisili_kkd') is-invalid @enderror" id="domisili_kkd" name="domisili_kkd"
                                                        rows="2">{{ old('domisili_kkd', $keluargaKandung->domisili_kkd) }}</textarea>
                                                </div>
                                                @error('domisili_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('no_telp_kkd', $keluargaKandung->no_telp_kkd) }}">
                                                </div>
                                                @error('no_telp_kkd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
