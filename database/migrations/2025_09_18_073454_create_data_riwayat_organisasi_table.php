...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('x08_dt_riwayat_organisasi', function (Blueprint $table) {
            $table->id();
            $table->string('id_kode_x03', 20);
            $table->string('id_kode', 20)->unique()->comment('X080725001');
            ...
            $table->text('tugas');
            $table->enum('sts_kepesertaan', ['Aktif', 'Tidak Aktif']);
    ...
    {
        Schema::dropIfExists('x08_dt_riwayat_organisasi');
    }
};
